      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6 animate-fade-up">
          <div className="p-8 rounded-3xl bg-white shadow-xl">
            <h3 className="font-heading text-2xl font-bold mb-6 text-[hsl(0_0%_6%)]">
              Contáctanos
            </h3>
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full py-4 px-6 rounded-2xl bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold transition-all duration-300 mb-6"
            >
            ...
            <div className="space-y-4">
              <p className="text-sm font-medium text-[hsl(0_0%_6%)]">Síguenos en redes</p>
              <div className="flex gap-4">
                <a
                  href="https://facebook.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 flex items-center justify-center rounded-full bg-[hsl(0_0%_95%)] hover:bg-[hsl(170_100%_37%)] hover:text-white text-[hsl(0_0%_6%)] transition-all duration-300"
                  aria-label="Facebook"
                >
